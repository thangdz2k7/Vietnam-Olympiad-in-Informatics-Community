...
files\validator.exe --group "subtask3" < files\tests\validator-tests\01 2>> validator-tests.log
if not errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\validator.exe --group "subtask3" < files\tests\validator-tests\02 2>> validator-tests.log
if errorlevel 1 (
