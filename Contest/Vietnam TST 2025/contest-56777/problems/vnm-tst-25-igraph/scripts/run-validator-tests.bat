...
files\valid.exe --group "Sub3" < files\tests\validator-tests\01 2>> validator-tests.log
if errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe --group "Sub4" < files\tests\validator-tests\02 2>> validator-tests.log
if errorlevel 1 (
    echo Validator returned non-zero exit code for a valid test 1>> validator-tests.log
    echo Validator returned non-zero exit code for a valid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe --group "Sub4" < files\tests\validator-tests\03 2>> validator-tests.log
if not errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe --group "Sub4" < files\tests\validator-tests\04 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe --group "Sub3" < files\tests\validator-tests\05 2>> validator-tests.log
if errorlevel 1 (
    echo Validator returned non-zero exit code for a valid test 1>> validator-tests.log
    echo Validator returned non-zero exit code for a valid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe --group "Sub3" < files\tests\validator-tests\06 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\valid.exe < files\tests\validator-tests\07 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
